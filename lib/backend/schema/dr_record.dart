...
class DrRecord extends FirestoreRecord {
  DrRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('DR');

  static Stream<DrRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => DrRecord.fromSnapshot(s));

  static Future<DrRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => DrRecord.fromSnapshot(s));

  static DrRecord fromSnapshot(DocumentSnapshot snapshot) => DrRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static DrRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      DrRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'DrRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createDrRecordData({
  String? sysGenBrand,
  String? sysGenModal,
  String? sysGenYOM,
  String? sysGenSN,
...
class DrRecordDocumentEquality implements Equality<DrRecord> {
  const DrRecordDocumentEquality();

  @override
  bool equals(DrRecord? e1, DrRecord? e2) {
  ...
  @override
  int hash(DrRecord? e) => const ListEquality().hash([
        e?.sysGenBrand,
        e?.sysGenModal,
        e?.sysGenYOM,
        e?.sysGenSN,
  ...
  @override
  bool isValidKey(Object? o) => o is DrRecord;
}

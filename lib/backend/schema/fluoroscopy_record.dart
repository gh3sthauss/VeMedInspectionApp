...
class FluoroscopyRecord extends FirestoreRecord {
  FluoroscopyRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Fluoroscopy');

  static Stream<FluoroscopyRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => FluoroscopyRecord.fromSnapshot(s));

  static Future<FluoroscopyRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => FluoroscopyRecord.fromSnapshot(s));

  static FluoroscopyRecord fromSnapshot(DocumentSnapshot snapshot) =>
      FluoroscopyRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static FluoroscopyRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      FluoroscopyRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'FluoroscopyRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is FluoroscopyRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createFluoroscopyRecordData({
  String? sysGenBrand,
  String? sysGenModal,
  String? sysGenYOM,
  String? sysGenSN,
...
class FluoroscopyRecordDocumentEquality implements Equality<FluoroscopyRecord> {
  const FluoroscopyRecordDocumentEquality();

  @override
  bool equals(FluoroscopyRecord? e1, FluoroscopyRecord? e2) {
  ...
  @override
  int hash(FluoroscopyRecord? e) => const ListEquality().hash([
        e?.sysGenBrand,
        e?.sysGenModal,
        e?.sysGenYOM,
        e?.sysGenSN,
  ...
  @override
  bool isValidKey(Object? o) => o is FluoroscopyRecord;
}

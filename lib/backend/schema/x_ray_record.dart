...
class XRayRecord extends FirestoreRecord {
  XRayRecord._(
  ...
  // "Tube2Model" field.
  String? _tube2Model;
  String get tube2Model => _tube2Model ?? '';
  bool hasTube2Model() => _tube2Model != null;
  ...
  // "Tube2YOM" field.
  String? _tube2YOM;
  String get tube2YOM => _tube2YOM ?? '';
  bool hasTube2YOM() => _tube2YOM != null;

  // "TableModel" field.
  String? _tableModel;
  String get tableModel => _tableModel ?? '';
  bool hasTableModel() => _tableModel != null;

  // "TableYOM" field.
  String? _tableYOM;
  String get tableYOM => _tableYOM ?? '';
  bool hasTableYOM() => _tableYOM != null;
  ...
  void _initializeFields() {
    ...
    _tube2Model = snapshotData['Tube2Model'] as String?;
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('XRay');

  static Stream<XRayRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => XRayRecord.fromSnapshot(s));

  static Future<XRayRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => XRayRecord.fromSnapshot(s));

  static XRayRecord fromSnapshot(DocumentSnapshot snapshot) => XRayRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static XRayRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      XRayRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'XRayRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createXRayRecordData({
  String? sysGenBrand,
  String? sysGenModal,
  String? sysGenYOM,
  String? sysGenSN,
...
class XRayRecordDocumentEquality implements Equality<XRayRecord> {
  const XRayRecordDocumentEquality();

  @override
  bool equals(XRayRecord? e1, XRayRecord? e2) {
  ...
  @override
  int hash(XRayRecord? e) => const ListEquality().hash([
        e?.sysGenBrand,
        e?.sysGenModal,
        e?.sysGenYOM,
        e?.sysGenSN,
  ...
  @override
  bool isValidKey(Object? o) => o is XRayRecord;
}

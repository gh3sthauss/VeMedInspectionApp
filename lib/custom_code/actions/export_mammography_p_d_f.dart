...
Future<void> exportMammographyPDF(
  ...
  try {
    ...
    final iconSvg = await rootBundle
        .loadString('assets/images/modality_icons/mammography.svg');
  ...
  pdf.addPage(
    pw.MultiPage(
      ...
      build: (context) => [
        // =========================== COVER PAGE ===========================
        _buildCoverPage(logoWidget, heroImage, docRef, modalityIcon, 'Mammography'),
        pw.NewPage(),

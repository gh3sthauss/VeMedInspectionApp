...
Future<void> exportCtPDF(
  ...
  try {
    ...
    final iconSvg = await rootBundle
        .loadString('assets/images/modality_icons/ct.svg');
  ...
  pdf.addPage(
    pw.MultiPage(
      ...
      build: (context) => [
        // =========================== COVER PAGE ===========================
        _buildCoverPage(logoWidget, heroImage, docRef, modalityIcon, 'CT'),
        pw.NewPage(),
        ...
        _infoTable(rows: [
          ...
          ['Tube Model', docRef.gantryTubeModel],
          ['Tube Year of Manufacture', docRef.gantryTubeYOM],
          ['Tube Scans/Sec', docRef.gantryTubeScanSec],
          ['Tube Oil Leakage', docRef.gantryTubeOilLeakage],
        ...
        _infoTable(rows: [
          ...
          ['Holders', docRef.accessoriesPHolders],

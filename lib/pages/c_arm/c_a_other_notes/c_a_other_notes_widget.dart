...
import 'c_a_other_notes_model.dart';
export 'c_a_other_notes_model.dart';

class CAOtherNotesWidget extends StatefulWidget {
  const CAOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'CA_OtherNotes';
  static String routePath = '/cAOtherNotes';

  @override
  State<CAOtherNotesWidget> createState() => _CAOtherNotesWidgetState();
}

class _CAOtherNotesWidgetState extends State<CAOtherNotesWidget> {
  late CAOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CArmRecord>(
      stream: CArmRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final cAOtherNotesCArmRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: cAOtherNotesCArmRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/cArm/otherNotes',
                                  existingPhotoUrls: cAOtherNotesCArmRecord
                                      .otherNotesPhotosURL
                                      .toList(),
                                ),
                              ),

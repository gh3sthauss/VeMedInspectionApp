...
import 'c_a_software_model.dart';
export 'c_a_software_model.dart';

class CASoftwareWidget extends StatefulWidget {
  const CASoftwareWidget({
    super.key,
  ...
  static String routeName = 'CA_Software';
  static String routePath = '/cASoftware';

  @override
  State<CASoftwareWidget> createState() => _CASoftwareWidgetState();
}

class _CASoftwareWidgetState extends State<CASoftwareWidget> {
  late CASoftwareModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CASoftwareModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CArmRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final cASoftwareCArmRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController1 ??=
                                  ...
                                  text: cASoftwareCArmRecord.softwareSN,
                                ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController2 ??=
                                    TextEditingController(
                                  text: cASoftwareCArmRecord.softwareVersion,
                                ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController3 ??=
                                    TextEditingController(
                                  text:
                                      cASoftwareCArmRecord.softwareOptionsText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/cArm/software',
                                  existingPhotoUrls: cASoftwareCArmRecord
                                      .softwareOptPicsURL
                                      .toList(),
                                ),
                              ),

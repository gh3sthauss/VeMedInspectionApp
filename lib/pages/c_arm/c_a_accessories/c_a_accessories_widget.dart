...
import 'c_a_accessories_model.dart';
export 'c_a_accessories_model.dart';

class CAAccessoriesWidget extends StatefulWidget {
  const CAAccessoriesWidget({
    super.key,
  ...
  static String routeName = 'CA_Accessories';
  static String routePath = '/cAAccessories';

  @override
  State<CAAccessoriesWidget> createState() => _CAAccessoriesWidgetState();
}

class _CAAccessoriesWidgetState extends State<CAAccessoriesWidget> {
  late CAAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CArmRecord>(
      stream: CArmRecord.getDocument(widget.docDataA!),
      builder: (context, snapshot) {
        ...
        final cAAccessoriesCArmRecord = snapshot.data!;
                ...
                children: [
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: cAAccessoriesCArmRecord.accessoriesCDs,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController2 ??=
                                  TextEditingController(
                                text: cAAccessoriesCArmRecord.accessoriesSpareP,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/cArm/accessories',
                                existingPhotoUrls:
                                    cAAccessoriesCArmRecord.accessoriesPicURL.toList(),
                              ),
                            ),
                          ],
                        ),
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.docDataA!.update(createCArmRecordData(

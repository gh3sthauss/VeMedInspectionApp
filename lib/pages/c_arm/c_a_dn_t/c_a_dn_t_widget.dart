...
import 'c_a_dn_t_model.dart';
export 'c_a_dn_t_model.dart';

class CADnTWidget extends StatefulWidget {
  const CADnTWidget({
    super.key,
  ...
  static String routeName = 'CA_DnT';
  static String routePath = '/cADnT';

  @override
  State<CADnTWidget> createState() => _CADnTWidgetState();
}
...
class _CADnTWidgetState extends State<CADnTWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CArmRecord>(
      stream: CArmRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final cADnTCArmRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: cADnTCArmRecord.dnTAddress,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: cADnTCArmRecord.dnTDockAvailable,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: cADnTCArmRecord.dnTNeedOfCrane,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController7 ??=
                                  TextEditingController(
                                text: cADnTCArmRecord.dnTSpecialAttention,
                              ),

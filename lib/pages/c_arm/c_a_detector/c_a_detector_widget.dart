...
import 'c_a_detector_model.dart';
export 'c_a_detector_model.dart';

class CADetectorWidget extends StatefulWidget {
  const CADetectorWidget({
    super.key,
  ...
  static String routeName = 'CA_Detector';
  static String routePath = '/cADetector';

  @override
  State<CADetectorWidget> createState() => _CADetectorWidgetState();
}
...
class _CADetectorWidgetState extends State<CADetectorWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CArmRecord>(
      stream: CArmRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final cADetectorCArmRecord = snapshot.data!;

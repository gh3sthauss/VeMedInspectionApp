...
import 'c_a_system_general_model.dart';
export 'c_a_system_general_model.dart';

class CASystemGeneralWidget extends StatefulWidget {
  const CASystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'CA_SystemGeneral';
  static String routePath = '/cASystemGeneral';

  @override
  State<CASystemGeneralWidget> createState() => _CASystemGeneralWidgetState();
}

class _CASystemGeneralWidgetState extends State<CASystemGeneralWidget> {
  late CASystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CASystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CArmRecord>(
      stream: CArmRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final cASystemGeneralCArmRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: cASystemGeneralCArmRecord.sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: cASystemGeneralCArmRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: cASystemGeneralCArmRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: cASystemGeneralCArmRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: cASystemGeneralCArmRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/cArm/systemGeneral',
                                existingPhotoUrls: cASystemGeneralCArmRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.docDataSysGen!.update(createCArmRecordData(

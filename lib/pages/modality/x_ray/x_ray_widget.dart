...
import 'x_ray_model.dart';
export 'x_ray_model.dart';

class XRayWidget extends StatefulWidget {
  const XRayWidget({
    super.key,
    required this.docRefXRay,
  });

  final DocumentReference? docRefXRay;

  static String routeName = 'X-Ray';
  static String routePath = '/xRay';

  @override
  State<XRayWidget> createState() => _XRayWidgetState();
}
                    ...
                    children: [
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(
                              XRSystemGeneralWidget.routeName,
                              queryParameters: {
                      ...
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(
                              XRConsoleNWorkstationsWidget.routeName,
                              queryParameters: {

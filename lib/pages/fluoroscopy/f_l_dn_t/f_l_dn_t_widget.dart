...
import 'f_l_dn_t_model.dart';
export 'f_l_dn_t_model.dart';

class FLDnTWidget extends StatefulWidget {
  const FLDnTWidget({
    super.key,
  ...
  static String routeName = 'FL_DnT';
  static String routePath = '/fLDnT';

  @override
  State<FLDnTWidget> createState() => _FLDnTWidgetState();
}

class _FLDnTWidgetState extends State<FLDnTWidget> {
  late FLDnTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLDnTModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final fLDnTFluoroscopyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: fLDnTFluoroscopyRecord.dnTAddress,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: fLDnTFluoroscopyRecord.dnTFloor,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: fLDnTFluoroscopyRecord.dnTDoorS,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: fLDnTFluoroscopyRecord.dnTDockAvailable,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: fLDnTFluoroscopyRecord.dnTNeedOfCrane,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController6 ??=
                                  TextEditingController(
                                text: fLDnTFluoroscopyRecord.dnTTools,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController7 ??=
                                  TextEditingController(
                                text:
                                    fLDnTFluoroscopyRecord.dnTSpecialAttention,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/fluoroscopy/dnT',
                          existingPhotoUrls:

...
import 'f_l_system_general_model.dart';
export 'f_l_system_general_model.dart';

class FLSystemGeneralWidget extends StatefulWidget {
  const FLSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'FL_SystemGeneral';
  static String routePath = '/fLSystemGeneral';

  @override
  State<FLSystemGeneralWidget> createState() => _FLSystemGeneralWidgetState();
}

class _FLSystemGeneralWidgetState extends State<FLSystemGeneralWidget> {
  late FLSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final fLSystemGeneralFluoroscopyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: fLSystemGeneralFluoroscopyRecord
                                    .sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text:
                                    fLSystemGeneralFluoroscopyRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: fLSystemGeneralFluoroscopyRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/fluoroscopy/systemGeneral',
                                existingPhotoUrls: fLSystemGeneralFluoroscopyRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),

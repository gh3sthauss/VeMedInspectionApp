...
import 'f_l_detector_model.dart';
export 'f_l_detector_model.dart';

class FLDetectorWidget extends StatefulWidget {
  const FLDetectorWidget({
    super.key,
    this.docDataDetector,
  });

  final DocumentReference? docDataDetector;

  static String routeName = 'FL_Detector';
  static String routePath = '/fLDetector';

  @override
  State<FLDetectorWidget> createState() => _FLDetectorWidgetState();
}

class _FLDetectorWidgetState extends State<FLDetectorWidget> {
  late FLDetectorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLDetectorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final fLDetectorFluoroscopyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: fLDetectorFluoroscopyRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: fLDetectorFluoroscopyRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: fLDetectorFluoroscopyRecord.detectorYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: fLDetectorFluoroscopyRecord
                                    .detectorCondition,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/fluoroscopy/detector',
                          existingPhotoUrls:
                              fLDetectorFluoroscopyRecord.detectorPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

...
import 'f_l_table_model.dart';
export 'f_l_table_model.dart';

class FLTableWidget extends StatefulWidget {
  const FLTableWidget({
    super.key,
  ...
  static String routeName = 'FL_Table';
  static String routePath = '/fLTable';
...
class _FLTableWidgetState extends State<FLTableWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLTableModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final fLTableFluoroscopyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: fLTableFluoroscopyRecord.tableModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: fLTableFluoroscopyRecord.tableYOM,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/fluoroscopy/table',
                          existingPhotoUrls:
                              fLTableFluoroscopyRecord.tablePicURL.toList(),
                        ),
                      ),
                    ],
                  ),

...
import 'f_l_cosmetic_model.dart';
export 'f_l_cosmetic_model.dart';

class FLCosmeticWidget extends StatefulWidget {
  const FLCosmeticWidget({
    super.key,
  ...
  static String routeName = 'FL_Cosmetic';
  static String routePath = '/fLCosmetic';

  @override
  State<FLCosmeticWidget> createState() => _FLCosmeticWidgetState();
}

class _FLCosmeticWidgetState extends State<FLCosmeticWidget> {
  late FLCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final fLCosmeticFluoroscopyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      fLCosmeticFluoroscopyRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/fluoroscopy/cosmetic',
                                  existingPhotoUrls: fLCosmeticFluoroscopyRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

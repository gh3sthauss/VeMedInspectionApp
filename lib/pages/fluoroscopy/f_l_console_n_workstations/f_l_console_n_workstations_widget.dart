...
import 'f_l_console_n_workstations_model.dart';
export 'f_l_console_n_workstations_model.dart';

class FLConsoleNWorkstationsWidget extends StatefulWidget {
  const FLConsoleNWorkstationsWidget({
    super.key,
  ...
  static String routeName = 'FL_ConsoleNWorkstations';
  static String routePath = '/fLConsoleNWorkstations';

  @override
  State<FLConsoleNWorkstationsWidget> createState() =>
      _FLConsoleNWorkstationsWidgetState();
}

class _FLConsoleNWorkstationsWidgetState
    extends State<FLConsoleNWorkstationsWidget> {
  late FLConsoleNWorkstationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLConsoleNWorkstationsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final fLConsoleNWorkstationsFluoroscopyRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text:
                                              fLConsoleNWorkstationsFluoroscopyRecord
                                                  .cnWConsoleMSN,
                                        ),
                                        focusNode:
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/fluoroscopy/consoleModel',
                                          existingPhotoUrls:
                                              fLConsoleNWorkstationsFluoroscopyRecord
                                                  .cnWCMOptPURL
                                                  .toList(),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/fluoroscopy/workstation',
                                          existingPhotoUrls:
                                              fLConsoleNWorkstationsFluoroscopyRecord
                                                  .cnWWorkstationOptPURL
                                                  .toList(),

...
import 'f_l_other_notes_model.dart';
export 'f_l_other_notes_model.dart';

class FLOtherNotesWidget extends StatefulWidget {
  const FLOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'FL_OtherNotes';
  static String routePath = '/fLOtherNotes';

  @override
  State<FLOtherNotesWidget> createState() => _FLOtherNotesWidgetState();
}

class _FLOtherNotesWidgetState extends State<FLOtherNotesWidget> {
  late FLOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final fLOtherNotesFluoroscopyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      fLOtherNotesFluoroscopyRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/fluoroscopy/otherNotes',
                                  existingPhotoUrls:
                                      fLOtherNotesFluoroscopyRecord
                                          .otherNotesPhotosURL
                                          .toList(),
                                ),
                              ),
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await fLOtherNotesFluoroscopyRecord.reference

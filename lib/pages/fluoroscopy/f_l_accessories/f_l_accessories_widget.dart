...
import 'f_l_accessories_model.dart';
export 'f_l_accessories_model.dart';

class FLAccessoriesWidget extends StatefulWidget {
  const FLAccessoriesWidget({
    super.key,
  ...
  static String routeName = 'FL_Accessories';
  static String routePath = '/fLAccessories';

  @override
  State<FLAccessoriesWidget> createState() => _FLAccessoriesWidgetState();
}

class _FLAccessoriesWidgetState extends State<FLAccessoriesWidget> {
  late FLAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FLAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<FluoroscopyRecord>(
      stream: FluoroscopyRecord.getDocument(widget.docDataA!),
      builder: (context, snapshot) {
        ...
        final fLAccessoriesFluoroscopyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: fLAccessoriesFluoroscopyRecord
                                    .accessoriesCDs,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/fluoroscopy/accessories',
                          existingPhotoUrls: fLAccessoriesFluoroscopyRecord
                              .accessoriesPicURL
                              .toList(),
                        ),
                      ),

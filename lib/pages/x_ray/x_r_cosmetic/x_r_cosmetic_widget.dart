...
import 'x_r_cosmetic_model.dart';
export 'x_r_cosmetic_model.dart';

class XRCosmeticWidget extends StatefulWidget {
  const XRCosmeticWidget({
    super.key,
  ...
  static String routeName = 'XR_Cosmetic';
  static String routePath = '/xRCosmetic';

  @override
  State<XRCosmeticWidget> createState() => _XRCosmeticWidgetState();
}

class _XRCosmeticWidgetState extends State<XRCosmeticWidget> {
  late XRCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XRCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final xRCosmeticXRayRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: xRCosmeticXRayRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/xray/cosmetic',
                                  existingPhotoUrls: xRCosmeticXRayRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.docDataCC!.update(createXRayRecordData(

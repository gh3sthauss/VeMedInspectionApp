...
import 'x_r_accessories_model.dart';
export 'x_r_accessories_model.dart';

class XRAccessoriesWidget extends StatefulWidget {
  const XRAccessoriesWidget({
    super.key,
  ...
  static String routeName = 'XR_Accessories';
  static String routePath = '/xRAccessories';

  @override
  State<XRAccessoriesWidget> createState() => _XRAccessoriesWidgetState();
}

class _XRAccessoriesWidgetState extends State<XRAccessoriesWidget> {
  late XRAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XRAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataA!),
      builder: (context, snapshot) {
        ...
        final xRAccessoriesXRayRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: xRAccessoriesXRayRecord.accessoriesCDs,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController2 ??=
                                  TextEditingController(
                                text: xRAccessoriesXRayRecord.accessoriesSpareP,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/xray/accessories',
                                existingPhotoUrls: xRAccessoriesXRayRecord
                                    .accessoriesPicURL
                                    .toList(),
                              ),
                            ),

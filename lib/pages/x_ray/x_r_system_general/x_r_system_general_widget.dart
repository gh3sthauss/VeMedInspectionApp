...
import 'x_r_system_general_model.dart';
export 'x_r_system_general_model.dart';

class XRSystemGeneralWidget extends StatefulWidget {
  const XRSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'XR_SystemGeneral';
  static String routePath = '/xRSystemGeneral';

  @override
  State<XRSystemGeneralWidget> createState() => _XRSystemGeneralWidgetState();
}
...
class _XRSystemGeneralWidgetState extends State<XRSystemGeneralWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final xRSystemGeneralXRayRecord = snapshot.data!;
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: valueOrDefault<String>(
                                  xRSystemGeneralXRayRecord.sysGenDocName,
                                  'Unnamed Document',
                                ),
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: xRSystemGeneralXRayRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: xRSystemGeneralXRayRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: xRSystemGeneralXRayRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: xRSystemGeneralXRayRecord.sysGenSN,
                              ),

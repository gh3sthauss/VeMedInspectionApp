...
import 'x_r_other_notes_model.dart';
export 'x_r_other_notes_model.dart';

class XROtherNotesWidget extends StatefulWidget {
  const XROtherNotesWidget({
    super.key,
  ...
  static String routeName = 'XR_OtherNotes';
  static String routePath = '/xROtherNotes';

  @override
  State<XROtherNotesWidget> createState() => _XROtherNotesWidgetState();
}

class _XROtherNotesWidgetState extends State<XROtherNotesWidget> {
  late XROtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XROtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final xROtherNotesXRayRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: xROtherNotesXRayRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/xray/otherNotes',
                                  existingPhotoUrls: xROtherNotesXRayRecord
                                      .otherNotesPhotosURL
                                      .toList(),
                                ),
                              ),

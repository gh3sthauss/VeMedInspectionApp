...
import 'x_r_table_model.dart';
export 'x_r_table_model.dart';

class XRTableWidget extends StatefulWidget {
  const XRTableWidget({
    super.key,
  ...
  static String routeName = 'XR_Table';
  static String routePath = '/xRTable';

  @override
  State<XRTableWidget> createState() => _XRTableWidgetState();
}

class _XRTableWidgetState extends State<XRTableWidget> {
  late XRTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XRTableModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docRefSoft!),
      builder: (context, snapshot) {
        ...
        final xRTableXRayRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: xRTableXRayRecord.tableModel,
                              ),
                              focusNode: _model.textFocusNode1,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Table Model',
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: xRTableXRayRecord.tableYOM,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                arrayFieldName: 'TablePicURL',
                                storagePathPrefix:
                                    'users/$currentUserUid/xray/table',
                                existingPhotoUrls:
                                    xRTableXRayRecord.tablePicURL.toList(),
                              ),
                            ),
                          ],
                        ),

...
import 'x_r_detector_model.dart';
export 'x_r_detector_model.dart';

class XRDetectorWidget extends StatefulWidget {
  const XRDetectorWidget({
    super.key,
  ...
  static String routeName = 'XR_Detector';
  static String routePath = '/xRDetector';

  @override
  State<XRDetectorWidget> createState() => _XRDetectorWidgetState();
}
...
class _XRDetectorWidgetState extends State<XRDetectorWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final xRDetectorXRayRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: xRDetectorXRayRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: xRDetectorXRayRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: xRDetectorXRayRecord.detectorYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: xRDetectorXRayRecord.detectorCondition,
                              ),

...
import 'x_r_dn_t_model.dart';
export 'x_r_dn_t_model.dart';

class XRDnTWidget extends StatefulWidget {
  const XRDnTWidget({
    super.key,
  ...
  static String routeName = 'XR_DnT';
  static String routePath = '/xRDnT';

  @override
  State<XRDnTWidget> createState() => _XRDnTWidgetState();
}

class _XRDnTWidgetState extends State<XRDnTWidget> {
  late XRDnTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XRDnTModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final xRDnTXRayRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: xRDnTXRayRecord.dnTAddress,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: xRDnTXRayRecord.dnTDockAvailable,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: xRDnTXRayRecord.dnTNeedOfCrane,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController7 ??=
                                  TextEditingController(
                                text: xRDnTXRayRecord.dnTSpecialAttention,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/xray/dnT',
                                existingPhotoUrls:
                                    xRDnTXRayRecord.dnTPicURL.toList(),
                              ),
                            ),
                          ],
                        ),

...
import 'x_r_tube_model.dart';
export 'x_r_tube_model.dart';

class XRTubeWidget extends StatefulWidget {
  const XRTubeWidget({
    super.key,
  ...
  static String routeName = 'XR_Tube';
  static String routePath = '/xRTube';

  @override
  State<XRTubeWidget> createState() => _XRTubeWidgetState();
}

class _XRTubeWidgetState extends State<XRTubeWidget> {
  late XRTubeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XRTubeModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final xRTubeXRayRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: xRTubeXRayRecord.tube1Model,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: xRTubeXRayRecord.tube1YOM,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/xray/tube',
                                existingPhotoUrls:
                                    xRTubeXRayRecord.tubePicURL.toList(),
                              ),
                            ),
                          ],
                        ),

...
import 'x_r_console_n_workstations_model.dart';
export 'x_r_console_n_workstations_model.dart';

class XRConsoleNWorkstationsWidget extends StatefulWidget {
  const XRConsoleNWorkstationsWidget({
    super.key,
  ...
  static String routeName = 'XR_ConsoleNWorkstations';
  static String routePath = '/xRConsoleNWorkstations';

  @override
  State<XRConsoleNWorkstationsWidget> createState() =>
      _XRConsoleNWorkstationsWidgetState();
}

class _XRConsoleNWorkstationsWidgetState
    extends State<XRConsoleNWorkstationsWidget> {
  late XRConsoleNWorkstationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XRConsoleNWorkstationsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<XRayRecord>(
      stream: XRayRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final xRConsoleNWorkstationsXRayRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text: xRConsoleNWorkstationsXRayRecord
                                              .cnWConsoleMSN,
                                        ),
                                        focusNode:
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/xray/consoleModel',
                                          existingPhotoUrls:
                                              xRConsoleNWorkstationsXRayRecord
                                                  .cnWCMOptPURL
                                                  .toList(),
                                        ),
                                      ),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/xray/workstation',
                                          existingPhotoUrls:
                                              xRConsoleNWorkstationsXRayRecord
                                                  .cnWWorkstationOptPURL
                                                  .toList(),

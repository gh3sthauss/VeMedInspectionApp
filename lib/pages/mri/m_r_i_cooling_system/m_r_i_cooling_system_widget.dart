...
import 'm_r_i_cooling_system_model.dart';
export 'm_r_i_cooling_system_model.dart';

class MRICoolingSystemWidget extends StatefulWidget {
  const MRICoolingSystemWidget({
    super.key,
    required this.docRefCooling,
  });

  final DocumentReference? docRefCooling;

  static String routeName = 'MRI_CoolingSystem';
  static String routePath = '/mRICoolingSystem';

  @override
  State<MRICoolingSystemWidget> createState() => _MRICoolingSystemWidgetState();
}

class _MRICoolingSystemWidgetState extends State<MRICoolingSystemWidget> {
  late MRICoolingSystemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRICoolingSystemModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      stream: MriRecord.getDocument(widget.docRefCooling!),
      builder: (context, snapshot) {
        ...
        final mRICoolingSystemMriRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                          ...
                                          text: mRICoolingSystemMriRecord
                                              .coolerCompModel,
                                        ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          collectionPath: 'MRI',
                          docId: widget.docRefCooling!.id,
                          arrayFieldName: 'CoolingSystemPicURL',
                          storagePathPrefix:
                              'users/$currentUserUid/mri/coolingSystem',
                          existingPhotoUrls: mRICoolingSystemMriRecord
                              .coolingSystemPicURL
                              .toList(),
                        ),
                      ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.docRefCooling!.update(createMriRecordData(
                          ...
                          coolerCompLAR: _model.textInputTextController5.text,
                          coldHeadModel: _model.textInputTextController6.text,
                          coldHeadLastR: _model.textInputTextController7.text,
                        ));

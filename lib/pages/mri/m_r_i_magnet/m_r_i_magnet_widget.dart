...
import 'm_r_i_magnet_model.dart';
export 'm_r_i_magnet_model.dart';

class MRIMagnetWidget extends StatefulWidget {
  const MRIMagnetWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'MRI_Magnet';
  static String routePath = '/mRIMagnet';

  @override
  State<MRIMagnetWidget> createState() => _MRIMagnetWidgetState();
}

class _MRIMagnetWidgetState extends State<MRIMagnetWidget> {
  late MRIMagnetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRIMagnetModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      stream: MriRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final mRIMagnetMriRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mRIMagnetMriRecord.magnetModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: mRIMagnetMriRecord.magnetSN,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: mRIMagnetMriRecord.magnetYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: mRIMagnetMriRecord.magnetPressure,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: mRIMagnetMriRecord.magnetShieldTemp,
                              ),
                              focusNode: _model.textFocusNode5,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Shield Temperature',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController6 ??=
                                  TextEditingController(
                                text: mRIMagnetMriRecord.magnetHELevel,
                              ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.docDataSysGen!.update(createMriRecordData(
                          ...
                          magnetPressure: _model.textTextController4.text,
                          magnetShieldTemp: _model.textTextController5.text,
                          magnetHELevel: _model.textTextController6.text,
                        ));

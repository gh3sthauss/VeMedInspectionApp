...
import 'm_r_i_other_notes_model.dart';
export 'm_r_i_other_notes_model.dart';

class MRIOtherNotesWidget extends StatefulWidget {
  const MRIOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'MRI_OtherNotes';
  static String routePath = '/mRIOtherNotes';

  @override
  State<MRIOtherNotesWidget> createState() => _MRIOtherNotesWidgetState();
}

class _MRIOtherNotesWidgetState extends State<MRIOtherNotesWidget> {
  late MRIOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRIOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      stream: MriRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final mRIOtherNotesMriRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: mRIOtherNotesMriRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/mri/otherNotes',
                                  existingPhotoUrls: mRIOtherNotesMriRecord
                                      .otherNotesPhotosURL
                                      .toList(),
                                ),
                              ),

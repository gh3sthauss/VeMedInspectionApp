...
import 'm_r_i_powerstages_model.dart';
export 'm_r_i_powerstages_model.dart';

class MRIPowerstagesWidget extends StatefulWidget {
  const MRIPowerstagesWidget({
    super.key,
  ...
  static String routeName = 'MRI_Powerstages';
  static String routePath = '/mRIPowerstages';

  @override
  State<MRIPowerstagesWidget> createState() => _MRIPowerstagesWidgetState();
}

class _MRIPowerstagesWidgetState extends State<MRIPowerstagesWidget> {
  late MRIPowerstagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRIPowerstagesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final mRIPowerstagesMriRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  CompactAppBar(title: 'Powerstages'),
                  Expanded(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mRIPowerstagesMriRecord.powerStages1SN,
                              ),
                              focusNode: _model.textFocusNode1,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'PS1 Serial Number',
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: mRIPowerstagesMriRecord.powerStages2SN,
                              ),
                              focusNode: _model.textFocusNode2,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'PS2 Serial Number',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: mRIPowerstagesMriRecord.powerStages3SN,
                              ),
                              focusNode: _model.textFocusNode3,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'PS3 Serial Number',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          arrayFieldName: 'PowerstagesPicURL',
                          storagePathPrefix:
                              'users/$currentUserUid/mri/powerstages',
                          existingPhotoUrls: mRIPowerstagesMriRecord
                              .powerstagesPicURL
                              .toList(),
                        ),
                      ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await mRIPowerstagesMriRecord.reference
                          ...
                          powerStages3SN: _model.textTextController3.text,
                        ));

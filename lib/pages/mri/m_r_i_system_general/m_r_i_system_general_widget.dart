...
import 'm_r_i_system_general_model.dart';
export 'm_r_i_system_general_model.dart';

class MRISystemGeneralWidget extends StatefulWidget {
  const MRISystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'MRI_SystemGeneral';
  static String routePath = '/mRISystemGeneral';

  @override
  State<MRISystemGeneralWidget> createState() => _MRISystemGeneralWidgetState();
}

class _MRISystemGeneralWidgetState extends State<MRISystemGeneralWidget> {
  late MRISystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRISystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final mRISystemGeneralMriRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mRISystemGeneralMriRecord.sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: mRISystemGeneralMriRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: mRISystemGeneralMriRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: mRISystemGeneralMriRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: mRISystemGeneralMriRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/mri/systemGeneral',
                                existingPhotoUrls: mRISystemGeneralMriRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),

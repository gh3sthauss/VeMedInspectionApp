...
import 'm_r_i_cosmetic_model.dart';
export 'm_r_i_cosmetic_model.dart';

class MRICosmeticWidget extends StatefulWidget {
  const MRICosmeticWidget({
    super.key,
  ...
  static String routeName = 'MRI_Cosmetic';
  static String routePath = '/mRICosmetic';

  @override
  State<MRICosmeticWidget> createState() => _MRICosmeticWidgetState();
}

class _MRICosmeticWidgetState extends State<MRICosmeticWidget> {
  late MRICosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRICosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      stream: MriRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final mRICosmeticMriRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: mRICosmeticMriRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/mri/cosmetic',
                                  existingPhotoUrls: mRICosmeticMriRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.docDataCC!.update(createMriRecordData(

...
import 'mri_ecgperu_model.dart';
export 'mri_ecgperu_model.dart';

class MriEcgperuWidget extends StatefulWidget {
  const MriEcgperuWidget({
    super.key,
  ...
  static String routeName = 'MRI_ECGPERU';
  static String routePath = '/mriEcgperu';

  @override
  State<MriEcgperuWidget> createState() => _MriEcgperuWidgetState();
}

class _MriEcgperuWidgetState extends State<MriEcgperuWidget> {
  late MriEcgperuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MriEcgperuModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final mriEcgperuMriRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mriEcgperuMriRecord.eCGModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: mriEcgperuMriRecord.ecgsn,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: mriEcgperuMriRecord.eCGFuncChecked,
                              ),
                              ...
                              decoration: InputDecoration(
                                labelText:
                                    'Functionality Checked With Test Tools',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          arrayFieldName: 'EcgPicURL',
                          storagePathPrefix: 'users/$currentUserUid/mri/ecg',
                          existingPhotoUrls:

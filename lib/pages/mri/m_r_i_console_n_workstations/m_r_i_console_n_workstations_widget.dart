...
import 'm_r_i_console_n_workstations_model.dart';
export 'm_r_i_console_n_workstations_model.dart';

class MRIConsoleNWorkstationsWidget extends StatefulWidget {
  const MRIConsoleNWorkstationsWidget({
    super.key,
  ...
  static String routeName = 'MRI_ConsoleNWorkstations';
  static String routePath = '/mRIConsoleNWorkstations';

  @override
  State<MRIConsoleNWorkstationsWidget> createState() =>
      _MRIConsoleNWorkstationsWidgetState();
}

class _MRIConsoleNWorkstationsWidgetState
    extends State<MRIConsoleNWorkstationsWidget> {
  late MRIConsoleNWorkstationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRIConsoleNWorkstationsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      stream: MriRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final mRIConsoleNWorkstationsMriRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text: mRIConsoleNWorkstationsMriRecord
                                              .cnWConsoleSN,
                                        ),
                                        focusNode:
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          arrayFieldName:
                                              'CnWConsoleOptionsPicsURL',
                                          storagePathPrefix:
                                              'users/$currentUserUid/mri/consoleModel',
                                          existingPhotoUrls:
                                              mRIConsoleNWorkstationsMriRecord
                                                  .cnWConsoleOptionsPicsURL
                                                  .toList(),
                                        ),
                                      ),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          collectionPath: 'MRI',
                                          docId: widget.docDataCW!.id,
                                          arrayFieldName: 'CnWWSOptionsPicsURL',
                                          storagePathPrefix:
                                              'users/$currentUserUid/mri/workstation',
                                          existingPhotoUrls:
                                              mRIConsoleNWorkstationsMriRecord
                                                  .cnWWSOptionsPicsURL
                                                  .toList(),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.docDataCW!.update(createMriRecordData(
                          ...
                          cnWWSSN: _model.textInputTextController3.text,
                          cnWWSOptionsText:
                              _model.textInputTextController5.text,
                          cnWWSSW: _model.textInputTextController4.text,
                          cnWCDAvailable: _model.textInputTextController6.text,
                        ));

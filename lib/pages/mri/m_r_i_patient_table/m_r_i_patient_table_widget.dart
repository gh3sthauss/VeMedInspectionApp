...
import 'm_r_i_patient_table_model.dart';
export 'm_r_i_patient_table_model.dart';

class MRIPatientTableWidget extends StatefulWidget {
  const MRIPatientTableWidget({
    super.key,
  ...
  static String routeName = 'MRI_PatientTable';
  static String routePath = '/mRIPatientTable';

  @override
  State<MRIPatientTableWidget> createState() => _MRIPatientTableWidgetState();
}

class _MRIPatientTableWidgetState extends State<MRIPatientTableWidget> {
  late MRIPatientTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRIPatientTableModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final mRIPatientTableMriRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text:
                                    mRIPatientTableMriRecord.patientTableModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: mRIPatientTableMriRecord.patientTableSN,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          arrayFieldName: 'PatientTablePicURL',
                          storagePathPrefix:
                              'users/$currentUserUid/mri/patientTable',
                          existingPhotoUrls: mRIPatientTableMriRecord
                              .patientTablePicURL
                              .toList(),
                        ),
                      ),

...
import 'm_r_i_dn_t_model.dart';
export 'm_r_i_dn_t_model.dart';

class MRIDnTWidget extends StatefulWidget {
  const MRIDnTWidget({
    super.key,
  ...
  static String routeName = 'MRI_DnT';
  static String routePath = '/mRIDnT';

  @override
  State<MRIDnTWidget> createState() => _MRIDnTWidgetState();
}

class _MRIDnTWidgetState extends State<MRIDnTWidget> {
  late MRIDnTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MRIDnTModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MriRecord>(
      stream: MriRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final mRIDnTMriRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mRIDnTMriRecord.dnTAddress,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: mRIDnTMriRecord.dntDockAvailable,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: mRIDnTMriRecord.dntNeedOfCrane,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController7 ??=
                                  TextEditingController(
                                text: mRIDnTMriRecord.dntSpecialAttention,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix: 'users/$currentUserUid/mri/dnT',
                          existingPhotoUrls: mRIDnTMriRecord.dnTPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

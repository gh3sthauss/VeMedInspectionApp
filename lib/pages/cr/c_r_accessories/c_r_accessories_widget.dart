...
import 'c_r_accessories_model.dart';
export 'c_r_accessories_model.dart';

class CRAccessoriesWidget extends StatefulWidget {
  const CRAccessoriesWidget({
    super.key,
  ...
  static String routeName = 'CR_Accessories';
  static String routePath = '/cRAccessories';

  @override
  State<CRAccessoriesWidget> createState() => _CRAccessoriesWidgetState();
}

class _CRAccessoriesWidgetState extends State<CRAccessoriesWidget> {
  late CRAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CrRecord>(
      stream: CrRecord.getDocument(widget.docDataA!),
      builder: (context, snapshot) {
        ...
        final cRAccessoriesCrRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: cRAccessoriesCrRecord.accessoriesCDs,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController2 ??=
                                  TextEditingController(
                                text: cRAccessoriesCrRecord.accessoriesSpareP,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/cr/accessories',
                          existingPhotoUrls:
                              cRAccessoriesCrRecord.accessoriesPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

...
import 'c_r_detector_model.dart';
export 'c_r_detector_model.dart';

class CRDetectorWidget extends StatefulWidget {
  const CRDetectorWidget({
    super.key,
  ...
  static String routeName = 'CR_Detector';
  static String routePath = '/cRDetector';

  @override
  State<CRDetectorWidget> createState() => _CRDetectorWidgetState();
}

class _CRDetectorWidgetState extends State<CRDetectorWidget> {
  late CRDetectorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRDetectorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CrRecord>(
      stream: CrRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final cRDetectorCrRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: cRDetectorCrRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: cRDetectorCrRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: cRDetectorCrRecord.detectorYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: cRDetectorCrRecord.detectorCondition,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/cr/detector',
                          existingPhotoUrls:
                              cRDetectorCrRecord.detectorPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

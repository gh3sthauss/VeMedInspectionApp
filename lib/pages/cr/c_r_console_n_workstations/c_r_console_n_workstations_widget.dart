...
import 'c_r_console_n_workstations_model.dart';
export 'c_r_console_n_workstations_model.dart';

class CRConsoleNWorkstationsWidget extends StatefulWidget {
  const CRConsoleNWorkstationsWidget({
    super.key,
  ...
  static String routeName = 'CR_ConsoleNWorkstations';
  static String routePath = '/cRConsoleNWorkstations';

  @override
  State<CRConsoleNWorkstationsWidget> createState() =>
      _CRConsoleNWorkstationsWidgetState();
}

class _CRConsoleNWorkstationsWidgetState
    extends State<CRConsoleNWorkstationsWidget> {
  late CRConsoleNWorkstationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRConsoleNWorkstationsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CrRecord>(
      stream: CrRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final cRConsoleNWorkstationsCrRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text: cRConsoleNWorkstationsCrRecord
                                              .cnWConsoleMSN,
                                        ),
                                        focusNode:
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/cr/consoleModel',
                                          existingPhotoUrls:
                                              cRConsoleNWorkstationsCrRecord
                                                  .cnWCMOptPURL
                                                  .toList(),
                                        ),
                                      ),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/cr/workstation',
                                          existingPhotoUrls:
                                              cRConsoleNWorkstationsCrRecord
                                                  .cnWWorkstationOptPURL
                                                  .toList(),

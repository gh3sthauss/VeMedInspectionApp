...
import 'c_r_system_general_model.dart';
export 'c_r_system_general_model.dart';

class CRSystemGeneralWidget extends StatefulWidget {
  const CRSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'CR_SystemGeneral';
  static String routePath = '/cRSystemGeneral';

  @override
  State<CRSystemGeneralWidget> createState() => _CRSystemGeneralWidgetState();
}

class _CRSystemGeneralWidgetState extends State<CRSystemGeneralWidget> {
  late CRSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CrRecord>(
      stream: CrRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final cRSystemGeneralCrRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: cRSystemGeneralCrRecord.sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: cRSystemGeneralCrRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: cRSystemGeneralCrRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: cRSystemGeneralCrRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: cRSystemGeneralCrRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/cr/systemGeneral',
                                existingPhotoUrls: cRSystemGeneralCrRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.docDataSysGen!.update(createCrRecordData(

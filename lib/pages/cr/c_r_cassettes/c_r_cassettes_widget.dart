...
import 'c_r_cassettes_model.dart';
export 'c_r_cassettes_model.dart';

class CRCassettesWidget extends StatefulWidget {
  const CRCassettesWidget({
    super.key,
  ...
  static String routeName = 'CR_Cassettes';
  static String routePath = '/cRCassettes';

  @override
  State<CRCassettesWidget> createState() => _CRCassettesWidgetState();
}

class _CRCassettesWidgetState extends State<CRCassettesWidget> {
  late CRCassettesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRCassettesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CrRecord>(
      stream: CrRecord.getDocument(widget.docRefProbes!),
      builder: (context, snapshot) {
        ...
        final cRCassettesCrRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                          ...
                                          text: cRCassettesCrRecord.cR1Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController2 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR1Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController3 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR1Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController4 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR2Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController5 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR2Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController6 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR2Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController7 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR3Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController8 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR3Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController9 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR3Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController10 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR4Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController11 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR4Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController12 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR4Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController13 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR5Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController14 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR5Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController15 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR5Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController16 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR6Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController17 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR6Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController18 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR6Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController19 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR7Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController20 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR7Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController21 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR7Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController22 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR8Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController23 ??=
                                                TextEditingController(
                                          text: cRCassettesCrRecord.cR8Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController24 ??=
                                                TextEditingController(
                                          text:
                                              cRCassettesCrRecord.cR8Condition,
                                        ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/cr/cassettes',
                          existingPhotoUrls:
                              cRCassettesCrRecord.cassettesPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

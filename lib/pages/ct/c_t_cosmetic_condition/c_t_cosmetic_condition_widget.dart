...
import 'c_t_cosmetic_condition_model.dart';
export 'c_t_cosmetic_condition_model.dart';

class CTCosmeticConditionWidget extends StatefulWidget {
  const CTCosmeticConditionWidget({
    super.key,
  ...
  static String routeName = 'CT_CosmeticCondition';
  static String routePath = '/cTCosmeticCondition';

  @override
  State<CTCosmeticConditionWidget> createState() =>
      _CTCosmeticConditionWidgetState();
}

class _CTCosmeticConditionWidgetState extends State<CTCosmeticConditionWidget> {
  late CTCosmeticConditionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CTCosmeticConditionModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CtRecord>(
      stream: CtRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final cTCosmeticConditionCtRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      cTCosmeticConditionCtRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/ct/cosmetic',
                                  existingPhotoUrls: cTCosmeticConditionCtRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

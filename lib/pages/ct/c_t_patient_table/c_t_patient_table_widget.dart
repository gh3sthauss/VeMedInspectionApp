...
import 'c_t_patient_table_model.dart';
export 'c_t_patient_table_model.dart';

class CTPatientTableWidget extends StatefulWidget {
  const CTPatientTableWidget({
    super.key,
  ...
  static String routeName = 'CT_PatientTable';
  static String routePath = '/cTPatientTable';

  @override
  State<CTPatientTableWidget> createState() => _CTPatientTableWidgetState();
}

class _CTPatientTableWidgetState extends State<CTPatientTableWidget> {
  late CTPatientTableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CTPatientTableModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CtRecord>(
      stream: CtRecord.getDocument(widget.docDataPT!),
      builder: (context, snapshot) {
        ...
        final cTPatientTableCtRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: cTPatientTableCtRecord.pTModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: cTPatientTableCtRecord.ptsn,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: cTPatientTableCtRecord.ptmc,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/ct/patientTable',
                                existingPhotoUrls: cTPatientTableCtRecord
                                    .patientTablePicURL
                                    .toList(),
                              ),
                            ),

...
import 'c_t_gantry_model.dart';
export 'c_t_gantry_model.dart';

class CTGantryWidget extends StatefulWidget {
  const CTGantryWidget({
    super.key,
    required this.docDataGantry,
  });

  final DocumentReference? docDataGantry;

  static String routeName = 'CT_Gantry';
  static String routePath = '/cTGantry';

  @override
  State<CTGantryWidget> createState() => _CTGantryWidgetState();
}
...
class _CTGantryWidgetState extends State<CTGantryWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CtRecord>(
      stream: CtRecord.getDocument(widget.docDataGantry!),
      builder: (context, snapshot) {
        ...
        final cTGantryCtRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                          ...
                                          text: cTGantryCtRecord.gantryModelSN,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController2 ??=
                                                TextEditingController(
                                          text:
                                              cTGantryCtRecord.gantryTubeModel,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController3 ??=
                                                TextEditingController(
                                          text: cTGantryCtRecord.gantryTubeYOM,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController6 ??=
                                                TextEditingController(
                                          text: cTGantryCtRecord.gantryDetModal,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController7 ??=
                                                TextEditingController(
                                          text: cTGantryCtRecord.gantryDetSN,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController8 ??=
                                                TextEditingController(
                                          text: cTGantryCtRecord.gantryDetDC,
                                        ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.docDataGantry!.update(createCtRecordData(
                          ...
                          gantryDetModal: _model.textInputTextController6.text,
                          gantryDetSN: _model.textInputTextController7.text,
                          gantryTubeModel: _model.textInputTextController2.text,
                          gantryTubeOilLeakage:

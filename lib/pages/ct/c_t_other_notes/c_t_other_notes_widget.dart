...
import 'c_t_other_notes_model.dart';
export 'c_t_other_notes_model.dart';

class CTOtherNotesWidget extends StatefulWidget {
  const CTOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'CT_OtherNotes';
  static String routePath = '/cTOtherNotes';

  @override
  State<CTOtherNotesWidget> createState() => _CTOtherNotesWidgetState();
}

class _CTOtherNotesWidgetState extends State<CTOtherNotesWidget> {
  late CTOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CTOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CtRecord>(
      stream: CtRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final cTOtherNotesCtRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: cTOtherNotesCtRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/ct/otherNotes',
                                  existingPhotoUrls: cTOtherNotesCtRecord
                                      .otherNotesPhotosURL
                                      .toList(),
                                ),
                              ),

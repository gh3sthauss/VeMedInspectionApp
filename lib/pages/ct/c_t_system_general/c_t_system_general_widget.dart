...
import 'c_t_system_general_model.dart';
export 'c_t_system_general_model.dart';

class CTSystemGeneralWidget extends StatefulWidget {
  const CTSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'CT_SystemGeneral';
  static String routePath = '/cTSystemGeneral';

  @override
  State<CTSystemGeneralWidget> createState() => _CTSystemGeneralWidgetState();
}

class _CTSystemGeneralWidgetState extends State<CTSystemGeneralWidget> {
  late CTSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CTSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CtRecord>(
      stream: CtRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final cTSystemGeneralCtRecord = snapshot.data!;
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: cTSystemGeneralCtRecord.sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: cTSystemGeneralCtRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: cTSystemGeneralCtRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: cTSystemGeneralCtRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: cTSystemGeneralCtRecord.sysGenSN,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController6 ??=
                                  TextEditingController(
                                text: cTSystemGeneralCtRecord.sysGenSlices,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/ct/systemGeneral',
                                existingPhotoUrls:
                                    cTSystemGeneralCtRecord.deviceImg.toList(),
                              ),
                            ),
                          ],
                        ),
                        NotesField(
                          controller: _model.notesTextController ??=
                              TextEditingController(
                            text: cTSystemGeneralCtRecord.sysGenNotes,
                          ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        widget.docDataSysGen!.update(createCtRecordData(
                          ...
                          sysGenSlices: _model.textTextController6.text,
                          sysGenDocName: _model.textTextController1.text,
                          sysGenNotes: _model.notesTextController.text,
                        ));

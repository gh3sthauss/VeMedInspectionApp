                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        contentPadding: EdgeInsetsDirectional.fromSTEB(
                            20.0, 10.0, 0.0, 10.0),
                        suffixIcon:
                            _model.textInputTextController1!.text.isNotEmpty
                                ? InkWell(
                                    onTap: () async {
                                      _model.textInputTextController1?.clear();
                                      safeSetState(() {});
                                    },
                                    child: Icon(
                                      Icons.clear,
                      ...
                      validator: _model.textInputTextController1Validator
                          .asValidator(context),
                      inputFormatters: [
                        if (!isAndroid && !isiOS)
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon:
                          _model.textInputTextController2!.text.isNotEmpty
                              ? InkWell(
                                  onTap: () async {
                                    _model.textInputTextController2?.clear();
                                    safeSetState(() {});
                                  },
                                  child: Icon(
                                    Icons.clear,
                    ...
                    validator: _model.textInputTextController2Validator
                        .asValidator(context),
                    inputFormatters: [
                      if (!isAndroid && !isiOS)
                        TextInputFormatter.withFunction((oldValue, newValue) {

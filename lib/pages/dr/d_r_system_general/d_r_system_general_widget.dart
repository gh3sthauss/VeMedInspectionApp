...
import 'd_r_system_general_model.dart';
export 'd_r_system_general_model.dart';

class DRSystemGeneralWidget extends StatefulWidget {
  const DRSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'DR_SystemGeneral';
  static String routePath = '/dRSystemGeneral';

  @override
  State<DRSystemGeneralWidget> createState() => _DRSystemGeneralWidgetState();
}

class _DRSystemGeneralWidgetState extends State<DRSystemGeneralWidget> {
  late DRSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DRSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DrRecord>(
      stream: DrRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final dRSystemGeneralDrRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: dRSystemGeneralDrRecord.sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: dRSystemGeneralDrRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: dRSystemGeneralDrRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: dRSystemGeneralDrRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: dRSystemGeneralDrRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/dr/systemGeneral',
                                existingPhotoUrls: dRSystemGeneralDrRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),

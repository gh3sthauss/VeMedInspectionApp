...
import 'd_r_cosmetic_model.dart';
export 'd_r_cosmetic_model.dart';

class DRCosmeticWidget extends StatefulWidget {
  const DRCosmeticWidget({
    super.key,
  ...
  static String routeName = 'DR_Cosmetic';
  static String routePath = '/dRCosmetic';

  @override
  State<DRCosmeticWidget> createState() => _DRCosmeticWidgetState();
}

class _DRCosmeticWidgetState extends State<DRCosmeticWidget> {
  late DRCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DRCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DrRecord>(
      stream: DrRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final dRCosmeticDrRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: dRCosmeticDrRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/dr/cosmetic',
                                  existingPhotoUrls: dRCosmeticDrRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

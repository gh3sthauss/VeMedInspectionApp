...
import 'd_r_other_notes_model.dart';
export 'd_r_other_notes_model.dart';

class DROtherNotesWidget extends StatefulWidget {
  const DROtherNotesWidget({
    super.key,
  ...
  static String routeName = 'DR_OtherNotes';
  static String routePath = '/dROtherNotes';

  @override
  State<DROtherNotesWidget> createState() => _DROtherNotesWidgetState();
}

class _DROtherNotesWidgetState extends State<DROtherNotesWidget> {
  late DROtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DROtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DrRecord>(
      stream: DrRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final dROtherNotesDrRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: dROtherNotesDrRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/dr/otherNotes',
                                  existingPhotoUrls: dROtherNotesDrRecord
                                      .otherNotesPhotosURL
                                      .toList(),
                                ),
                              ),

...
import 'd_r_cassettes_model.dart';
export 'd_r_cassettes_model.dart';

class DRCassettesWidget extends StatefulWidget {
  const DRCassettesWidget({
    super.key,
  ...
  static String routeName = 'DR_Cassettes';
  static String routePath = '/dRCassettes';

  @override
  State<DRCassettesWidget> createState() => _DRCassettesWidgetState();
}

class _DRCassettesWidgetState extends State<DRCassettesWidget> {
  late DRCassettesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DRCassettesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DrRecord>(
      stream: DrRecord.getDocument(widget.docRefProbes!),
      builder: (context, snapshot) {
        ...
        final dRCassettesDrRecord = snapshot.data!;
                ...
                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                          ...
                                          text: dRCassettesDrRecord.cR1Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController2 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR1Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController3 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR1Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController4 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR2Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController5 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR2Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController6 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR2Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController7 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR3Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController8 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR3Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController9 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR3Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController10 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR4Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController11 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR4Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController12 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR4Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController13 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR5Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController14 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR5Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController15 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR5Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController16 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR6Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController17 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR6Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController18 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR6Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController19 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR7Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController20 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR7Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController21 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR7Condition,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController22 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR8Model,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController23 ??=
                                                TextEditingController(
                                          text: dRCassettesDrRecord.cR8Size,
                                        ),
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.textInputTextController24 ??=
                                                TextEditingController(
                                          text:
                                              dRCassettesDrRecord.cR8Condition,
                                        ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/dr/cassettes',
                          existingPhotoUrls:
                              dRCassettesDrRecord.cassettesPicURL.toList(),
                        ),
                      ),
                    ],
                  ),
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.docRefProbes!.update(createDrRecordData(

...
import 'd_r_detector_model.dart';
export 'd_r_detector_model.dart';

class DRDetectorWidget extends StatefulWidget {
  const DRDetectorWidget({
    super.key,
  ...
  static String routeName = 'DR_Detector';
  static String routePath = '/dRDetector';

  @override
  State<DRDetectorWidget> createState() => _DRDetectorWidgetState();
}

class _DRDetectorWidgetState extends State<DRDetectorWidget> {
  late DRDetectorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DRDetectorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DrRecord>(
      stream: DrRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final dRDetectorDrRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: dRDetectorDrRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: dRDetectorDrRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: dRDetectorDrRecord.detectorYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: dRDetectorDrRecord.detectorCondition,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/dr/detector',
                          existingPhotoUrls:

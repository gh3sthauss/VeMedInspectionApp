...
import 'm_m_cosmetic_model.dart';
export 'm_m_cosmetic_model.dart';

class MMCosmeticWidget extends StatefulWidget {
  const MMCosmeticWidget({
    super.key,
  ...
  static String routeName = 'MM_Cosmetic';
  static String routePath = '/mMCosmetic';

  @override
  State<MMCosmeticWidget> createState() => _MMCosmeticWidgetState();
}

class _MMCosmeticWidgetState extends State<MMCosmeticWidget> {
  late MMCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MMCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MammographyRecord>(
      stream: MammographyRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final mMCosmeticMammographyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      mMCosmeticMammographyRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/mammography/cosmetic',
                                  existingPhotoUrls: mMCosmeticMammographyRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

...
import 'm_m_accessories_model.dart';
export 'm_m_accessories_model.dart';

class MMAccessoriesWidget extends StatefulWidget {
  const MMAccessoriesWidget({
    super.key,
  ...
  static String routeName = 'MM_Accessories';
  static String routePath = '/mMAccessories';

  @override
  State<MMAccessoriesWidget> createState() => _MMAccessoriesWidgetState();
}

class _MMAccessoriesWidgetState extends State<MMAccessoriesWidget> {
  late MMAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MMAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MammographyRecord>(
      stream: MammographyRecord.getDocument(widget.docDataA!),
      builder: (context, snapshot) {
        ...
        final mMAccessoriesMammographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: mMAccessoriesMammographyRecord
                                    .accessoriesCDs,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/mammography/accessories',
                          existingPhotoUrls: mMAccessoriesMammographyRecord
                              .accessoriesPicURL
                              .toList(),
                        ),
                      ),

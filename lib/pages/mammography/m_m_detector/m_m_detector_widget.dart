...
import 'm_m_detector_model.dart';
export 'm_m_detector_model.dart';

class MMDetectorWidget extends StatefulWidget {
  const MMDetectorWidget({
    super.key,
  ...
  static String routeName = 'MM_Detector';
  static String routePath = '/mMDetector';

  @override
  State<MMDetectorWidget> createState() => _MMDetectorWidgetState();
}

class _MMDetectorWidgetState extends State<MMDetectorWidget> {
  late MMDetectorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MMDetectorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MammographyRecord>(
      stream: MammographyRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final mMDetectorMammographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mMDetectorMammographyRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: mMDetectorMammographyRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: mMDetectorMammographyRecord.detectorYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: mMDetectorMammographyRecord
                                    .detectorCondition,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/mammography/detector',
                          existingPhotoUrls: mMDetectorMammographyRecord
                              .detectorPicURL
                              .toList(),
                        ),
                      ),

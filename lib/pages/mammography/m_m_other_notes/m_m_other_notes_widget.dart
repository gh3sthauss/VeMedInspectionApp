...
import 'm_m_other_notes_model.dart';
export 'm_m_other_notes_model.dart';

class MMOtherNotesWidget extends StatefulWidget {
  const MMOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'MM_OtherNotes';
  static String routePath = '/mMOtherNotes';

  @override
  State<MMOtherNotesWidget> createState() => _MMOtherNotesWidgetState();
}

class _MMOtherNotesWidgetState extends State<MMOtherNotesWidget> {
  late MMOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MMOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MammographyRecord>(
      stream: MammographyRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final mMOtherNotesMammographyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      mMOtherNotesMammographyRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/mammography/otherNotes',
                                  existingPhotoUrls:
                                      mMOtherNotesMammographyRecord
                                          .otherNotesPhotosURL
                                          .toList(),
                                ),
                              ),

...
import 'm_m_console_n_workstations_model.dart';
export 'm_m_console_n_workstations_model.dart';

class MMConsoleNWorkstationsWidget extends StatefulWidget {
  const MMConsoleNWorkstationsWidget({
    super.key,
  ...
  static String routeName = 'MM_ConsoleNWorkstations';
  static String routePath = '/mMConsoleNWorkstations';

  @override
  State<MMConsoleNWorkstationsWidget> createState() =>
      _MMConsoleNWorkstationsWidgetState();
}

class _MMConsoleNWorkstationsWidgetState
    extends State<MMConsoleNWorkstationsWidget> {
  late MMConsoleNWorkstationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MMConsoleNWorkstationsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MammographyRecord>(
      stream: MammographyRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final mMConsoleNWorkstationsMammographyRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text:
                                              mMConsoleNWorkstationsMammographyRecord
                                                  .cnWConsoleMSN,
                                        ),
                                        focusNode:
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/mammography/consoleModel',
                                          existingPhotoUrls:
                                              mMConsoleNWorkstationsMammographyRecord
                                                  .cnWCMOptPURL
                                                  .toList(),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/mammography/workstation',
                                          existingPhotoUrls:
                                              mMConsoleNWorkstationsMammographyRecord
                                                  .cnWWorkstationOptPURL
                                                  .toList(),

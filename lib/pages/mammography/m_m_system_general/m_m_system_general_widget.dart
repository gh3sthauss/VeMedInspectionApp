...
import 'm_m_system_general_model.dart';
export 'm_m_system_general_model.dart';

class MMSystemGeneralWidget extends StatefulWidget {
  const MMSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'MM_SystemGeneral';
  static String routePath = '/mMSystemGeneral';

  @override
  State<MMSystemGeneralWidget> createState() => _MMSystemGeneralWidgetState();
}

class _MMSystemGeneralWidgetState extends State<MMSystemGeneralWidget> {
  late MMSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MMSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MammographyRecord>(
      stream: MammographyRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final mMSystemGeneralMammographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: mMSystemGeneralMammographyRecord
                                    .sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text:
                                    mMSystemGeneralMammographyRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: mMSystemGeneralMammographyRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/mammography/systemGeneral',
                                existingPhotoUrls: mMSystemGeneralMammographyRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),

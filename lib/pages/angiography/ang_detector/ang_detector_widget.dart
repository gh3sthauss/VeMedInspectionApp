...
import 'ang_detector_model.dart';
export 'ang_detector_model.dart';

class AngDetectorWidget extends StatefulWidget {
  const AngDetectorWidget({
    super.key,
    this.docDataAng,
  });

  final DocumentReference? docDataAng;

  static String routeName = 'Ang_Detector';
  static String routePath = '/angDetector';

  @override
  State<AngDetectorWidget> createState() => _AngDetectorWidgetState();
}

class _AngDetectorWidgetState extends State<AngDetectorWidget> {
  late AngDetectorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngDetectorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      stream: AngiographyRecord.getDocument(widget.docDataAng!),
      builder: (context, snapshot) {
        ...
        final angDetectorAngiographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text:
                                    angDetectorAngiographyRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: angDetectorAngiographyRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: angDetectorAngiographyRecord.detectorYOM,
                              ),
                              focusNode: _model.textFocusNode3,
                              textCapitalization: TextCapitalization.words,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Year of Manifacture',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: angDetectorAngiographyRecord
                                    .detectorCondition,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          docId: widget.docDataAng!.id,
                          arrayFieldName: 'DetectorPicURL',
                          storagePathPrefix:
                              'users/$currentUserUid/angiography/detector',
                          existingPhotoUrls: angDetectorAngiographyRecord
                              .detectorPicURL
                              .toList(),
                        ),
                      ),

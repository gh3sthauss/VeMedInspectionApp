...
import 'ang_dn_t_model.dart';
export 'ang_dn_t_model.dart';

class AngDnTWidget extends StatefulWidget {
  const AngDnTWidget({
    super.key,
  ...
  static String routeName = 'Ang_DnT';
  static String routePath = '/angDnT';

  @override
  State<AngDnTWidget> createState() => _AngDnTWidgetState();
}

class _AngDnTWidgetState extends State<AngDnTWidget> {
  late AngDnTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngDnTModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      stream: AngiographyRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final angDnTAngiographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: angDnTAngiographyRecord.dnTAddress,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: angDnTAngiographyRecord.dnTFloor,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: angDnTAngiographyRecord.dnTDoorS,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: angDnTAngiographyRecord.dnTDockAvailable,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: angDnTAngiographyRecord.dnTNeedOfCrane,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController6 ??=
                                  TextEditingController(
                                text: angDnTAngiographyRecord.dnTTools,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController7 ??=
                                  TextEditingController(
                                text:
                                    angDnTAngiographyRecord.dnTSpecialAttention,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/angiography/dnT',
                          existingPhotoUrls:
                              angDnTAngiographyRecord.dnTPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

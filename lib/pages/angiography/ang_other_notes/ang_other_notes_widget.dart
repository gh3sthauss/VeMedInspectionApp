...
import 'ang_other_notes_model.dart';
export 'ang_other_notes_model.dart';

class AngOtherNotesWidget extends StatefulWidget {
  const AngOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'Ang_OtherNotes';
  static String routePath = '/angOtherNotes';

  @override
  State<AngOtherNotesWidget> createState() => _AngOtherNotesWidgetState();
}

class _AngOtherNotesWidgetState extends State<AngOtherNotesWidget> {
  late AngOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      stream: AngiographyRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final angOtherNotesAngiographyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      angOtherNotesAngiographyRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/angiography/otherNotes',
                                  existingPhotoUrls:
                                      angOtherNotesAngiographyRecord
                                          .otherNotesPhotosURL
                                          .toList(),
                                ),
                              ),

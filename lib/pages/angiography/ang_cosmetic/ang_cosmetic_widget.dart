...
import 'ang_cosmetic_model.dart';
export 'ang_cosmetic_model.dart';

class AngCosmeticWidget extends StatefulWidget {
  const AngCosmeticWidget({
    super.key,
  ...
  static String routeName = 'Ang_Cosmetic';
  static String routePath = '/angCosmetic';

  @override
  State<AngCosmeticWidget> createState() => _AngCosmeticWidgetState();
}

class _AngCosmeticWidgetState extends State<AngCosmeticWidget> {
  late AngCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      stream: AngiographyRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final angCosmeticAngiographyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text:
                                      angCosmeticAngiographyRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/angiography/cosmetic',
                                  existingPhotoUrls: angCosmeticAngiographyRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

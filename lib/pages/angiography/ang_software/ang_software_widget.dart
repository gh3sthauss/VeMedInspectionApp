...
import 'ang_software_model.dart';
export 'ang_software_model.dart';

class AngSoftwareWidget extends StatefulWidget {
  const AngSoftwareWidget({
    super.key,
  ...
  static String routeName = 'Ang_Software';
  static String routePath = '/angSoftware';

  @override
  State<AngSoftwareWidget> createState() => _AngSoftwareWidgetState();
}

class _AngSoftwareWidgetState extends State<AngSoftwareWidget> {
  late AngSoftwareModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngSoftwareModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      stream: AngiographyRecord.getDocument(widget.docRefSoft!),
      builder: (context, snapshot) {
        ...
        final angSoftwareAngiographyRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController1 ??=
                                  ...
                                  text: angSoftwareAngiographyRecord.softwareSN,
                                ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController2 ??=
                                    TextEditingController(
                                  text: angSoftwareAngiographyRecord
                                      .softwareVersion,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/angiography/software',
                                  existingPhotoUrls: angSoftwareAngiographyRecord
                                      .softwareOptPicsURL
                                      .toList(),
                                ),
                              ),

...
import 'ang_accessories_model.dart';
export 'ang_accessories_model.dart';

class AngAccessoriesWidget extends StatefulWidget {
  const AngAccessoriesWidget({
    super.key,
    required this.docDataAng,
  });

  final DocumentReference? docDataAng;

  static String routeName = 'Ang_Accessories';
  static String routePath = '/angAccessories';

  @override
  State<AngAccessoriesWidget> createState() => _AngAccessoriesWidgetState();
}

class _AngAccessoriesWidgetState extends State<AngAccessoriesWidget> {
  late AngAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final angAccessoriesAngiographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: angAccessoriesAngiographyRecord
                                    .accessoriesCDs,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/angiography/accessories',
                          existingPhotoUrls: angAccessoriesAngiographyRecord
                              .accessoriesPicURL
                              .toList(),
                        ),
                      ),

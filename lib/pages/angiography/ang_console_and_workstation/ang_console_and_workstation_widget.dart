...
import 'ang_console_and_workstation_model.dart';
export 'ang_console_and_workstation_model.dart';

class AngConsoleAndWorkstationWidget extends StatefulWidget {
  const AngConsoleAndWorkstationWidget({
    super.key,
  ...
  static String routeName = 'Ang_ConsoleAndWorkstation';
  static String routePath = '/angConsoleAndWorkstation';

  @override
  State<AngConsoleAndWorkstationWidget> createState() =>
      _AngConsoleAndWorkstationWidgetState();
}

class _AngConsoleAndWorkstationWidgetState
    extends State<AngConsoleAndWorkstationWidget> {
  late AngConsoleAndWorkstationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngConsoleAndWorkstationModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      stream: AngiographyRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final angConsoleAndWorkstationAngiographyRecord = snapshot.data!;
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/angiography/consoleModel',
                                          existingPhotoUrls:
                                              angConsoleAndWorkstationAngiographyRecord
                                                  .cnWCMOptPURL
                                                  .toList(),

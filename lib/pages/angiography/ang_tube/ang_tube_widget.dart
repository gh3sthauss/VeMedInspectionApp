...
import 'ang_tube_model.dart';
export 'ang_tube_model.dart';

class AngTubeWidget extends StatefulWidget {
  const AngTubeWidget({
    super.key,
  ...
  static String routeName = 'Ang_Tube';
  static String routePath = '/angTube';

  @override
  State<AngTubeWidget> createState() => _AngTubeWidgetState();
}

class _AngTubeWidgetState extends State<AngTubeWidget> {
  late AngTubeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AngTubeModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AngiographyRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final angTubeAngiographyRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: angTubeAngiographyRecord.tube1Model,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: angTubeAngiographyRecord.tube1YOM,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/angiography/tube',
                          existingPhotoUrls:

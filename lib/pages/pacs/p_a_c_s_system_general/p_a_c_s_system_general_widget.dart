...
import 'p_a_c_s_system_general_model.dart';
export 'p_a_c_s_system_general_model.dart';

class PACSSystemGeneralWidget extends StatefulWidget {
  const PACSSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'PACS_SystemGeneral';
  static String routePath = '/pACSSystemGeneral';

  @override
  State<PACSSystemGeneralWidget> createState() =>
      _PACSSystemGeneralWidgetState();
}

class _PACSSystemGeneralWidgetState extends State<PACSSystemGeneralWidget> {
  late PACSSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final pACSSystemGeneralPacsRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: pACSSystemGeneralPacsRecord.sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: pACSSystemGeneralPacsRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: pACSSystemGeneralPacsRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: pACSSystemGeneralPacsRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: pACSSystemGeneralPacsRecord.sysGenSN,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/pacs/systemGeneral',
                                existingPhotoUrls: pACSSystemGeneralPacsRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),

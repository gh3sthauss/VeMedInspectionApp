...
import 'p_a_c_s_console_n_workstations_model.dart';
export 'p_a_c_s_console_n_workstations_model.dart';

class PACSConsoleNWorkstationsWidget extends StatefulWidget {
  const PACSConsoleNWorkstationsWidget({
    super.key,
  ...
  static String routeName = 'PACS_ConsoleNWorkstations';
  static String routePath = '/pACSConsoleNWorkstations';

  @override
  State<PACSConsoleNWorkstationsWidget> createState() =>
      _PACSConsoleNWorkstationsWidgetState();
}

class _PACSConsoleNWorkstationsWidgetState
    extends State<PACSConsoleNWorkstationsWidget> {
  late PACSConsoleNWorkstationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSConsoleNWorkstationsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataCW!),
      builder: (context, snapshot) {
        ...
        final pACSConsoleNWorkstationsPacsRecord = snapshot.data!;
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                          ...
                                          text:
                                              pACSConsoleNWorkstationsPacsRecord
                                                  .cnWConsoleMSN,
                                        ),
                                        focusNode:
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/pacs/consoleModel',
                                          existingPhotoUrls:
                                              pACSConsoleNWorkstationsPacsRecord
                                                  .cnWCMOptPURL
                                                  .toList(),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: PhotoUploadOutboxWidget(
                                          ...
                                          storagePathPrefix:
                                              'users/$currentUserUid/pacs/workstation',
                                          existingPhotoUrls:
                                              pACSConsoleNWorkstationsPacsRecord
                                                  .cnWWorkstationOptPURL
                                                  .toList(),

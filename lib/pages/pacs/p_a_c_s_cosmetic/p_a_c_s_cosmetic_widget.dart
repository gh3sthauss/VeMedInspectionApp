...
import 'p_a_c_s_cosmetic_model.dart';
export 'p_a_c_s_cosmetic_model.dart';

class PACSCosmeticWidget extends StatefulWidget {
  const PACSCosmeticWidget({
    super.key,
  ...
  static String routeName = 'PACS_Cosmetic';
  static String routePath = '/pACSCosmetic';

  @override
  State<PACSCosmeticWidget> createState() => _PACSCosmeticWidgetState();
}

class _PACSCosmeticWidgetState extends State<PACSCosmeticWidget> {
  late PACSCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final pACSCosmeticPacsRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: pACSCosmeticPacsRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/pacs/cosmetic',
                                  existingPhotoUrls: pACSCosmeticPacsRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

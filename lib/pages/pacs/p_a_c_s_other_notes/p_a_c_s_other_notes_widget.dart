...
import 'p_a_c_s_other_notes_model.dart';
export 'p_a_c_s_other_notes_model.dart';

class PACSOtherNotesWidget extends StatefulWidget {
  const PACSOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'PACS_OtherNotes';
  static String routePath = '/pACSOtherNotes';

  @override
  State<PACSOtherNotesWidget> createState() => _PACSOtherNotesWidgetState();
}

class _PACSOtherNotesWidgetState extends State<PACSOtherNotesWidget> {
  late PACSOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final pACSOtherNotesPacsRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: pACSOtherNotesPacsRecord.otherNotes,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/pacs/otherNotes',
                                  existingPhotoUrls: pACSOtherNotesPacsRecord
                                      .otherNotesPhotosURL
                                      .toList(),
                                ),
                              ),

...
import 'p_a_c_s_accessories_model.dart';
export 'p_a_c_s_accessories_model.dart';

class PACSAccessoriesWidget extends StatefulWidget {
  const PACSAccessoriesWidget({
    super.key,
  ...
  static String routeName = 'PACS_Accessories';
  static String routePath = '/pACSAccessories';

  @override
  State<PACSAccessoriesWidget> createState() => _PACSAccessoriesWidgetState();
}

class _PACSAccessoriesWidgetState extends State<PACSAccessoriesWidget> {
  late PACSAccessoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSAccessoriesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataA!),
      builder: (context, snapshot) {
        ...
        final pACSAccessoriesPacsRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController1 ??=
                                ...
                                text: pACSAccessoriesPacsRecord.accessoriesCDs,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textInputTextController2 ??=
                                  TextEditingController(
                                text:
                                    pACSAccessoriesPacsRecord.accessoriesSpareP,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/pacs/accessories',
                          existingPhotoUrls:
                              pACSAccessoriesPacsRecord.accessoriesPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

...
import 'p_a_c_s_detector_model.dart';
export 'p_a_c_s_detector_model.dart';

class PACSDetectorWidget extends StatefulWidget {
  const PACSDetectorWidget({
    super.key,
  ...
  static String routeName = 'PACS_Detector';
  static String routePath = '/pACSDetector';

  @override
  State<PACSDetectorWidget> createState() => _PACSDetectorWidgetState();
}

class _PACSDetectorWidgetState extends State<PACSDetectorWidget> {
  late PACSDetectorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSDetectorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataDetector!),
      builder: (context, snapshot) {
        ...
        final pACSDetectorPacsRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: pACSDetectorPacsRecord.detectorModel,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: pACSDetectorPacsRecord.detectorSize,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: pACSDetectorPacsRecord.detectorYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: pACSDetectorPacsRecord.detectorCondition,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix:
                              'users/$currentUserUid/pacs/detector',
                          existingPhotoUrls:

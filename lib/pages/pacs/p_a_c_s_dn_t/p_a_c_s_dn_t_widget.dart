...
import 'p_a_c_s_dn_t_model.dart';
export 'p_a_c_s_dn_t_model.dart';

class PACSDnTWidget extends StatefulWidget {
  const PACSDnTWidget({
    super.key,
  ...
  static String routeName = 'PACS_DnT';
  static String routePath = '/pACSDnT';

  @override
  State<PACSDnTWidget> createState() => _PACSDnTWidgetState();
}

class _PACSDnTWidgetState extends State<PACSDnTWidget> {
  late PACSDnTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PACSDnTModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PacsRecord>(
      stream: PacsRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final pACSDnTPacsRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: pACSDnTPacsRecord.dnTAddress,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text: pACSDnTPacsRecord.dnTFloor,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text: pACSDnTPacsRecord.dnTDoorS,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: pACSDnTPacsRecord.dnTDockAvailable,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: pACSDnTPacsRecord.dnTNeedOfCrane,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController6 ??=
                                  TextEditingController(
                                text: pACSDnTPacsRecord.dnTTools,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController7 ??=
                                  TextEditingController(
                                text: pACSDnTPacsRecord.dnTSpecialAttention,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          ...
                          storagePathPrefix: 'users/$currentUserUid/pacs/dnT',
                          existingPhotoUrls:
                              pACSDnTPacsRecord.dnTPicURL.toList(),
                        ),
                      ),
                    ],
                  ),

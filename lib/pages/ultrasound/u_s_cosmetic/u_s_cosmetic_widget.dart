...
import 'u_s_cosmetic_model.dart';
export 'u_s_cosmetic_model.dart';

class USCosmeticWidget extends StatefulWidget {
  const USCosmeticWidget({
    super.key,
  ...
  static String routeName = 'US_Cosmetic';
  static String routePath = '/uSCosmetic';

  @override
  State<USCosmeticWidget> createState() => _USCosmeticWidgetState();
}

class _USCosmeticWidgetState extends State<USCosmeticWidget> {
  late USCosmeticModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => USCosmeticModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UltrasoundRecord>(
      stream: UltrasoundRecord.getDocument(widget.docDataCC!),
      builder: (context, snapshot) {
        ...
        final uSCosmeticUltrasoundRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: uSCosmeticUltrasoundRecord.cosmeticText,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  storagePathPrefix:
                                      'users/$currentUserUid/ultrasound/cosmetic',
                                  existingPhotoUrls: uSCosmeticUltrasoundRecord
                                      .cosmeticPicURL
                                      .toList(),
                                ),
                              ),

...
import 'u_s_software_model.dart';
export 'u_s_software_model.dart';

class USSoftwareWidget extends StatefulWidget {
  const USSoftwareWidget({
    super.key,
  ...
  static String routeName = 'US_Software';
  static String routePath = '/uSSoftware';

  @override
  State<USSoftwareWidget> createState() => _USSoftwareWidgetState();
}

class _USSoftwareWidgetState extends State<USSoftwareWidget> {
  late USSoftwareModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => USSoftwareModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UltrasoundRecord>(
      stream: UltrasoundRecord.getDocument(widget.docRefSoft!),
      builder: (context, snapshot) {
        ...
        final uSSoftwareUltrasoundRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController1 ??=
                                  ...
                                  text: uSSoftwareUltrasoundRecord.softwareSN,
                                ),
                                focusNode: _model.textFocusNode1,
                                textCapitalization: TextCapitalization.words,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Software Serial Number',
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController2 ??=
                                    TextEditingController(
                                  text: uSSoftwareUltrasoundRecord
                                      .softwareVersion,
                                ),
                            ...
                            children: [
                              ...
                              wrapWithModel(
                                ...
                                child: PhotoUploadOutboxWidget(
                                  ...
                                  arrayFieldName: 'SoftwareOptPicsURL',
                                  storagePathPrefix:
                                      'users/$currentUserUid/ultrasound/software',
                                  existingPhotoUrls: uSSoftwareUltrasoundRecord
                                      .softwareOptPicsURL
                                      .toList(),
                                ),
                              ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.docRefSoft!
                          ...
                          softwareOptionsText:
                              _model.textTextController3.text,
                        ));

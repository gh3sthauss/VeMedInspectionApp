...
import 'u_s_system_general_model.dart';
export 'u_s_system_general_model.dart';

class USSystemGeneralWidget extends StatefulWidget {
  const USSystemGeneralWidget({
    super.key,
    this.docDataSysGen,
  });
  ...
  static String routeName = 'US_SystemGeneral';
  static String routePath = '/uSSystemGeneral';

  @override
  State<USSystemGeneralWidget> createState() => _USSystemGeneralWidgetState();
}

class _USSystemGeneralWidgetState extends State<USSystemGeneralWidget> {
  late USSystemGeneralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => USSystemGeneralModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UltrasoundRecord>(
      stream: UltrasoundRecord.getDocument(widget.docDataSysGen!),
      builder: (context, snapshot) {
        ...
        final uSSystemGeneralUltrasoundRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: uSSystemGeneralUltrasoundRecord
                                    .sysGenDocName,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController2 ??=
                                  TextEditingController(
                                text:
                                    uSSystemGeneralUltrasoundRecord.sysGenBrand,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController3 ??=
                                  TextEditingController(
                                text:
                                    uSSystemGeneralUltrasoundRecord.sysGenModal,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController4 ??=
                                  TextEditingController(
                                text: uSSystemGeneralUltrasoundRecord.sysGenYOM,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController5 ??=
                                  TextEditingController(
                                text: uSSystemGeneralUltrasoundRecord.sysGenSN,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController6 ??=
                                  TextEditingController(
                                text: uSSystemGeneralUltrasoundRecord.photosURL,
                              ),
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              ...
                              child: PhotoUploadOutboxWidget(
                                ...
                                storagePathPrefix:
                                    'users/$currentUserUid/ultrasound/systemGeneral',
                                existingPhotoUrls: uSSystemGeneralUltrasoundRecord
                                    .deviceImg
                                    .toList(),
                              ),
                            ),

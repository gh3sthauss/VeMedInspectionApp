...
import 'u_s_probes_model.dart';
export 'u_s_probes_model.dart';

class USProbesWidget extends StatefulWidget {
  const USProbesWidget({
    super.key,
  ...
  static String routeName = 'US_Probes';
  static String routePath = '/uSProbes';

  @override
  State<USProbesWidget> createState() => _USProbesWidgetState();
}

class _USProbesWidgetState extends State<USProbesWidget> {
  late USProbesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => USProbesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UltrasoundRecord>(
      stream: UltrasoundRecord.getDocument(widget.docRefProbes!),
      builder: (context, snapshot) {
        ...
        final uSProbesUltrasoundRecord = snapshot.data!;
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.docRefProbes!
                          ...
                          probe4Model: _model.textInputTextController10.text,
                          probe5Model: _model.textInputTextController13.text,
                          probe1YOM: _model.textInputTextController2.text,
                          probe2YOM: _model.textInputTextController5.text,
                          probe3YOM: _model.textInputTextController8.text,
                          probe4YOM: _model.textInputTextController11.text,
                          probe5YOM: _model.textInputTextController14.text,
                          probe1Condition: _model.textInputTextController3.text,
                          probe2Condition: _model.textInputTextController6.text,
                          probe3Condition: _model.textInputTextController9.text,
                          probe4Condition:
                              _model.textInputTextController12.text,
                          probe5Condition:

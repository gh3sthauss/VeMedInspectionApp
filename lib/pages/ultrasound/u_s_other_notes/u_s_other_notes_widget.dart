...
import 'u_s_other_notes_model.dart';
export 'u_s_other_notes_model.dart';

class USOtherNotesWidget extends StatefulWidget {
  const USOtherNotesWidget({
    super.key,
  ...
  static String routeName = 'US_OtherNotes';
  static String routePath = '/uSOtherNotes';

  @override
  State<USOtherNotesWidget> createState() => _USOtherNotesWidgetState();
}

class _USOtherNotesWidgetState extends State<USOtherNotesWidget> {
  late USOtherNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => USOtherNotesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UltrasoundRecord>(
      stream: UltrasoundRecord.getDocument(widget.docDataON!),
      builder: (context, snapshot) {
        ...
        final uSOtherNotesUltrasoundRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textTextController ??=
                                  ...
                                  text: uSOtherNotesUltrasoundRecord.otherNotes,
                                ),

...
import 'u_s_dismantle_n_transport_model.dart';
export 'u_s_dismantle_n_transport_model.dart';

class USDismantleNTransportWidget extends StatefulWidget {
  const USDismantleNTransportWidget({
    super.key,
  ...
  static String routeName = 'US_DismantleNTransport';
  static String routePath = '/uSDismantleNTransport';

  @override
  State<USDismantleNTransportWidget> createState() =>
      _USDismantleNTransportWidgetState();
}

class _USDismantleNTransportWidgetState
    extends State<USDismantleNTransportWidget> {
  late USDismantleNTransportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => USDismantleNTransportModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UltrasoundRecord>(
      stream: UltrasoundRecord.getDocument(widget.docDataDT!),
      builder: (context, snapshot) {
        ...
        final uSDismantleNTransportUltrasoundRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textTextController1 ??=
                                ...
                                text: uSDismantleNTransportUltrasoundRecord
                                    .dnTAddress,
                              ),
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: PhotoUploadOutboxWidget(
                          collectionPath: 'Ultrasound',
                          docId: widget.docDataDT!.id,
                          arrayFieldName: 'DnTPicURL',
                          storagePathPrefix:
                              'users/$currentUserUid/ultrasound/dnT',
                          existingPhotoUrls: uSDismantleNTransportUltrasoundRecord
                              .dnTPicURL
                              .toList(),
                        ),
                      ),
